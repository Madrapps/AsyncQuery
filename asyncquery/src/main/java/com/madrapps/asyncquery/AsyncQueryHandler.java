...
package com.madrapps.asyncquery;
...
public abstract class AsyncQueryHandler extends Handler {
     ...
     * @param uri           the Uri passed to the insert operation.
     * @param initialValues the ContentValues array parameter passed to the insert operation.
     */
    public final void startBulkInsert(int token, Object cookie, Uri uri,
                                  ContentValues[] initialValues) {
        // Use the token as what so cancelOperations works properly
        Message msg = mWorkerThreadHandler.obtainMessage(token);
